...
unsigned short G_u16alarmHour = 13;
...
_Bool pressedHour = 0;
_Bool pressedMin = 0;
_Bool pressedToggle = 0;
_Bool pressedSnooze = 0;
_Bool snooze = 0;
unsigned short G_au16startAddresses[] = {0x0000, 0x0017, 0x0036, 0x005a, 0x007c, 0x03B0, 0x00ae, 0x00c2, 0x00d8,
...
void playAudio (short s, short e);
void active(void);
...
__attribute__((picinterrupt(("")))) void timeInterrupt(void);
...
void readTime (short hour, short minute)
{
    if (timeSaid == 1)
    {
        if (hour < 12)
        {
            playHour(hour);
            playMinute10(minute);
            playAudio(G_au16startAddresses[0], G_au16endAddresses[0]);
        } else
        {
            unsigned short temphour = hour - 12;
            playHour(temphour);
            playMinute10(minute);
            playAudio(G_au16startAddresses[22], G_au16endAddresses[22]);
        }
        timeSaid = 0;
    }
    return;
...
void playMinute10 (short minute)
{
    if (minute/10 == 2){
           playAudio(G_au16startAddresses[32], G_au16endAddresses[32]);
    } else if (minute/10 == 3){
           playAudio(G_au16startAddresses[29], G_au16endAddresses[29]);
    } else if (minute/10 == 4){
           playAudio(G_au16startAddresses[9], G_au16endAddresses[9]);
    } else if (minute/10 == 5){
           playAudio(G_au16startAddresses[5], G_au16endAddresses[5]);
    }
     playMinute(minute);
    return;
}

void playMinute (short minute)
{
    if (minute/10 == 1) {
        if (minute == 10) {
            playAudio(G_au16startAddresses[27], G_au16endAddresses[27]);
        ...
        if (minute == 29 || minute == 39 || minute == 49 || minute == 59) {
            playAudio(G_au16startAddresses[10], G_au16endAddresses[10]);
        } else if ( minute == 28 || minute == 38 || minute == 48 || minute == 58) {
            playAudio(G_au16startAddresses[1], G_au16endAddresses[1]);
        } else if ( minute == 27 || minute == 37 || minute == 47 || minute == 57) {
            playAudio(G_au16startAddresses[23], G_au16endAddresses[23]);
        } else if (minute == 26 || minute == 36 || minute == 46 || minute == 56) {
            playAudio(G_au16startAddresses[25], G_au16endAddresses[25]);
        } else if (minute == 25 || minute == 35 || minute == 45 || minute == 55) {
            playAudio(G_au16startAddresses[6], G_au16endAddresses[6]);
        } else if (minute == 24 || minute == 34 || minute == 44 || minute == 54) {
            playAudio(G_au16startAddresses[7], G_au16endAddresses[7]);
        } else if ( minute == 23 || minute == 33 || minute == 43 || minute == 53) {
            playAudio(G_au16startAddresses[30], G_au16endAddresses[30]);
        } else if (minute == 22 || minute == 32 || minute == 42 || minute == 52) {
            playAudio(G_au16startAddresses[33], G_au16endAddresses[33]);
        } else if (minute == 21 || minute == 31 || minute == 41 || minute == 51) {
            playAudio(G_au16startAddresses[15], G_au16endAddresses[15]);
        } else if (minute == 9) {
...
void playAudio(short startAddress, short endAddress)
{
    if (G_8hasAddress == 0 && timeSaid)
    {
    G_u16Address = startAddress;
    G_u8charPointer = (unsigned char *) &G_u16Address;
    G_u16EndAddress = endAddress;
    G_8hasAddress = 1;
    active();
    }
     return;
...
void active()
{
    while (G_u16Address != G_u16EndAddress) {
        if (G_8counter == 0) {
            ...
            SD_SendCommand(17, 0x00, 0x00, G_u8charPointer[1], G_u8charPointer[0]);
            SD_Read8bitResponse();
            do {readMessage = SPI_Read();}
            while (readMessage == 0xFF);
        }

        G_8sendbyte = SPI_Read();
        writeDAQ(G_8sendbyte);
        G_8counter++;
        ...
        if (PORTBbits.RB0 == 1 && !pressedSnooze)
        {
            pressedSnooze = 1;
        }
        if (PORTBbits.RB0 == 0 && pressedSnooze)
        {
                pressedSnooze = 0;
                timeSaid = 0;
                G_8hasAddress = 0;
...
__attribute__((picinterrupt(("")))) void timeInterrupt()
{
